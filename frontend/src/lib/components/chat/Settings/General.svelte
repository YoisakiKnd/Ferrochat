			...
			<div class=" flex w-full justify-between">
				...
				<div class="flex items-center relative">
					<select
						...
						on:change={(e) => {
							localStorage.setItem('locale-chosen', '1');
							changeLanguage(lang);
						}}
					>
			...
			{#if $i18n.language === 'en-US'}
				<div class="mb-2 text-xs text-gray-400 dark:text-gray-500">
					...
					<a
						...
						href="https://github.com/ferrochat/ferrochat/blob/main/docs/CONTRIBUTING.md#-translations-and-internationalization"
						target="_blank"
					>
						Help us translate Ferrochat!
					</a>
				</div>
			{/if}
